...
import AddVacancyDialog from '../Dialog/AddWorkerVacancyDialog/AddVacancyDialog';
import {Icon, IconButton} from "@material-ui/core";
import UpdateVacancyDialog from "../Dialog/UpdateWorkerVacancyDialog/UpdateVacancyDialog";
...
class App extends Component {
  ...
  addVacancy = (data) => axios.post('http://localhost:8080/api/salary/%7Bvacancy_id%7D', data);

  updateVacancy = (vacancyId, vacancy) => axios.post(`${apiAddress}/api/salary/${vacancyId}`, vacancy);

  deleteVacancy = (id) => axios.delete(`${apiAddress}/api/salary/${id}`);
    ...
    return (
      <div className='vacancy-table'>
        <div className='title-container'>
          <h1 className='title'>Workday workers</h1>
